...
export const Landing = () => {
    ...
    return <div className="relative z-0 h-full w-full">
        ...
        <div className="min-h-screen ">
            ...
            {/* hero section */}
            <div className="flex flex-col h-full justify-center gap-4 items-center pt-15 px-10">
                {/* dashboard */}
                <div className="px-35 pt-10">
                    ...
                    rounded-2xl border-3 m-5 hover:border-purple-300  border-purple-400 p-2 bg-zinc-800" src="/images/dark-dash.png" alt="logo" width={800} height={500} />
                </div>
            ...
            <div className="h-screen w-full flex justify-end">
                ...
                <div className="flex h-full items-center w-full relative top-35 left-40">
                    <div className="border-2 opacity-35 animate-pulse delay-300 rounded-full border-pink-400 dark:border-zinc-400 w-250 h-250 flex justify-center items-center">
                ...
                < div className="flex h-full items-center relative ">
                    <div className="w-200 h-200 rounded absolute top-80 -left-140">
                        <Image style={{
                ...
                {/* text */}
                <div className="flex flex-col justify-center gap-5 w-2/3 h-full z-10 p-20">
                        ...
                        dark:from-zinc-800/80 dark:to-zinc-900/80 dark:hover:from-purple-900/80 dark:hover:to-zinc-900/80 
                        ...
                        p-10 w-3xl self-center rounded-3xl flex flex-col gap-2">
                        <div className="text-5xl dark:text-purple-50 font-semibold pb-5">
                            Tech stack
                        </div>
                        <div className="text-lg px-5 text-zinc-300">
            ...
            {/* Features */}
            <div className="h-screen flex flex-col justify-center p-25">
                <div className="flex h-full flex-col p-10 justify-center items-center text-center bg-linear-20  
                
                    dark:from-purple-800/80 not-dark:from-pink-600 dark:via-purple-950 to-zinc-800 via-pink-400 rounded-3xl gap-10 z-10
                ...
                ">
                    <div>
                        <div className="text-5xl dark:text-purple-50 font-semibold pb-3">
                            Features - Simple, Fast, Transparent.
                        </div>

                        <div className="text-xl">
                            Our platform is built to be fast, reliable, and developer-friendly.
                            Here’s what’s inside:
                        </div>
                    </div>
                    <ul className="text-xl space-y-6 text-left list-disc">
                        <li>
            ...
            <div className="relative h-screen p-20 flex w-full">
                ...
                <div className=" w-1/2 z-10 flex flex-col gap-7 h-fit mt-10 py-8 px-10 bg-linear-50 not-dark:bg-white dark:bg-zinc-900/50 rounded-2xl
                border-2 border-white/10 backdrop-blur-xl 
            ...
            <div className="flex h-screen px-40 justify-end my-10">
                ...
                <div className="absolute z-10 w-150 h-150 p-10 
                    flex flex-col justify-center bg-linear-0 
                    glow-breathe animate-[float_1s_ease-in-out_infinite] circle-hover
                    bg-zinc-900/90 border-pink-500 dark:border-purple-300 
                    shadow-2xl/90 shadow-pink-700 dark:shadow-purple-500 border-3 rounded-full text-center">
                    <div>
            ...
            text-zinc-800 flex flex-col justify-center text-center px-50 gap-15">
                ...
                <div className="text-5xl font-bold text-shadow-white/35 
                ...
                <div className="flex justify-center gap-10 w-full h-22">
                    ...
                    <div className="flex flex-col justify-between">
                        <div className="hover:scale-[1.05] hover:drop-shadow-[0_0_12px_rgba(150,0,255,0.5)]
                        transition-all duration-300">
                            <Image className="size-17 animate-bounce" style={{
                                animationDuration : '2s',
