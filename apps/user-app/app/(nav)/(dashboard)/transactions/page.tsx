  ...
  return <div className="w-full ">
    ...
    <div className="p-5">
      <div className="flex gap-5 pb-5 w-full ">
          ...
          <div className="flex w-1/2 text-center justify-between gap-4 items-center 
            bg-linear-180 dark:from-purple-800 dark:via-purple-900/70 dark:to-purple-950 
            via-pink-600/70 from-pink-700 text-3xl dark:text-slate-50 not-dark:text-white
            ...
            font-bold px-10 font-sans">
              <span className=" text-2xl/relaxed font-light"> Balance: </span> 
              <span> INR {balance} </span>
          </div>

          <div className="flex w-1/2 text-center justify-between gap-4 items-center border-2 
