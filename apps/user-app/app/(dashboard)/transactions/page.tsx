  ...
  return <div className="w-full ">
    ...
    <div className="px-10">
      <div className="flex gap-5 pb-5 w-full ">
          <div className="flex w-1/2 text-center justify-between gap-4 items-center bg-linear-180 dark:from-purple-700 dark:via-purple-600/70 dark:to-purple-500 via-pink-600/70 from-pink-700 text-3xl dark:text-slate-50 not-dark:text-white font-bold rounded-lg px-10 font-sans">
            <span className=" text-xl/relaxed font-light"> Balance: </span> 
            <span> INR {balance} </span>
          </div>
          <div className="flex w-1/2 text-center justify-between gap-4 items-center border-2 not-dark:border-slate-300 shadow dark:border-zinc-800 not-dark:bg-white dark:bg-zinc-700 text-3xl not-dark:text-pink-700 dark:text-purple-500 font-bold rounded-lg py-5 px-6 font-sans">
